...
<form id="form1" name="form2" method="post" action="">
    <table width="100%" border="1" align="center">
      <tr>
        <td width="30%" align="center" bgcolor="#666666"><font color="white"><strong>Curso</strong></font></td>
        <td width="30%" align="center" bgcolor="#666666"><font color="white"><strong>Alumno</strong></font></td>
		<td width="10%" align="center" bgcolor="#666666"><font color="white"><strong>Cuota N&deg;</strong></font></td>
		<td width="20%" align="center" bgcolor="#666666"><font color="white"><strong>Fecha de pago</strong></font></td>
		<td width="10%" align="center" bgcolor="#666666"><font color="white"><strong>Monto</strong></font></td>
      </tr>
	   ...
	   $contadorAlumnos = 0;
		...
		echo '<tr>';
			...
			echo '<td '.$color.' align="right">$ '.$rowCursos['monto_pagado'].'</td>';
		echo '</tr>';
...
<td align="center">  
	...
	<?php echo '<a href="excelCuotasSecretaria.php?anio='.$cursoA.'"><input type="button" value="Excel"/></a>';?>
      </p></td>
  </tr>
	</table>
</form>
