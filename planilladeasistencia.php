        ...
        <tr>
          ...
          <td width="75%"><select name="cursoF" size="1" class="myTextField" id="cursoF" onchange="evaluaring()" onkeyup="fn(this.form,this)" >
            ...
            <?php
                                         ...
                                         include_once "conexionCursosExtension.php";										 		
                                                 $tip1 = pg_query($conn,"SELECT id_cursos,nombre,duracion_desde,duracion_hasta FROM cursos where anio=$anio ORDER BY nombre;");
                                                  while($row1 = pg_fetch_array($tip1)){
...
<form id="form1" name="form2" method="post" target="_blank" action="imprimirasistencia.php"> 
  ...
  <tr>
    <td width="100%"  align="center">
      ...
      <p>
		...
		<a href="excelimprimirasistencia.php?curso=<?=$cursoF?>"><input type="button" value="Excel"/></a>
      </p>
	  </td>
  </tr>
</table>
