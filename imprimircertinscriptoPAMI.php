...
$sql= pg_query($conn,"select inscripto.nombre, inscripto.apellido, inscripto.telfijo, 
 ...
 cursos.monto, cursos.cantcuota from inscriptosxcurso full outer join inscripto on(inscriptosxcurso.fk_inscriptos = inscripto.id_inscripto) full outer join tipodocumento on(inscripto.fk_tipodoc = tipodocumento.id_tipodocumento) full outer join cursos on(inscriptosxcurso.fk_curso = cursos.id_cursos) INNER JOIN datosextra ON(datosextra.inscripto_datosextra = inscripto.id_inscripto) where inscriptosxcurso.id_inscriptosxcurso=$inscripto;");
