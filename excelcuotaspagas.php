...
header("content-disposition: attachment;filename=ListadoCuotasPagasPorCurso.xls");
...
<form id="form1" name="form2" method="post" action="">
	...
	<td colspan="3">
		<font size="4">Curso: 
		<?php
		$sqlCurso = pg_query("SELECT nombre FROM cursos WHERE id_cursos=$cursoF");
		$rowCurso = pg_fetch_array($sqlCurso);
      ...
      <tr>
        ...
        <td width="6%" bgcolor="#666666">Cuotas pagadas</td>
