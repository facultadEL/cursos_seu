...
<form id="form2" name="form2" method="post" action="">
  <tr>
    <td height="30" align="center"><p><strong>PLANILLA DE INSCRIPTOS A CURSOS</strong> </p>
...
<form id="form1" name="form2" method="post" target="_blank" action="imprimirjornada.php"> 
