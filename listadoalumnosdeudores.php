          ...
          <td width="75%"><select name="cursoF" size="1" class="myTextField" id="cursoF" onChange="evaluaring()"  onkeyup=fn(this.form,this)>
            ...
            <?php
                                         include_once "conexionCursosExtension.php";
                                                  ...
                                                  $tip1 = pg_query($conn,"SELECT id_cursos,nombre,anio FROM cursos where  anio=$cursoA;"); //comentar esta linea y descomentar la de arriba, es temporal el cambio
...
<form id="form1" name="form2" method="post" action="">
  ...
  <tr>
	...
	<?php echo '<a href="excelalumnodeudores.php?anio='.$cursoA.'&curso='.$cursoF.'"><input type="button" value="Excel"/></a>';?>
      </p></td>
  </tr>
	</table>
</form>
