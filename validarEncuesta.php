			...
			<div class="panel-body panel_body">
				...
				<div class="row">
					<div class="form-group">
						<div class="col-xs-8 col-sm-6 col-md-6 col-lg-6 col-xs-offset-2 col-sm-offset-3 col-md-offset-3 col-lg-offset-3"><input class="form-control text-center txt_dni" name="numdoc" type="text" pattern="([0-9]{1}|[0-9]{2})[0-9]{3}[0-9]{3}" id="dniAlumno" onblur="if(this.value != 0){validar(this.value)};" onkeydown="sacarColor('alerta1')" placeholder="INGRESE SU DNI" value="" maxlength="8" minlength="7" required title="Ingrese solo n&uacute;meros y 7 caracteres m&iacute;nimo" autocomplete="off" required autofocus /></div>
					</div>
				</div>
