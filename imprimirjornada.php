    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="1">
        <tr>
            ...
            <td align="center" valing="center">
                <b>PLANILLA DE INSCRIPCI&Oacute;N AL CURSO O JORNADA</b>
            </td>
            <td align="center">
                <b>RE1-PE1-02-06</b><br>
                Rev. 0<br>
                P&aacute;g 1 de 1
            </td>
        </tr>
...
<table width="100%" border="1" cellpadding="2" cellspacing="0">
  <tr>
      <td align="center" ><strong><label style="font-size: 11pt;">APELLIDO Y NOMBRE</label></strong></td>
    <td align="center" ><strong><label style="font-size: 11pt;">DNI</label></strong></td>
    <td align="center" ><strong><label style="font-size: 11pt;">DIRECCI&Oacute;N</label></strong></td>
    <td align="center" ><strong><label style="font-size: 11pt;">E-MAIL</label></strong></td>
    <td align="center" ><strong><label style="font-size: 11pt;">TELEFONO</label></strong></td>    
    </tr>
 <?
 ...
 for($i=1;$i<$cantInscriptos+1;$i++){
	...
	echo '<tr>';
	echo '<td align="left">';
        echo '<label style="font-size: 9pt;">'.$rowDatosIns['apellido'].', '.$rowDatosIns['nombre'].'</label>';
        echo '</td>';
        echo '<td align="center">';
        echo '<label style="font-size: 9pt;">'.$rowDatosIns['dni'].'</label>';
        echo '</td>';
        echo '<td align="center">';
        echo '<label style="font-size: 9pt;">'.$rowDatosIns['direccion'].'</label>';
        echo '</td>';
        echo '<td align="center">';
        echo '<label style="font-size: 9pt;">'.$rowDatosIns['mail'].'</label>';
        echo '</td>';
        echo '<td align="center">';
        if($rowDatosIns['telcel']==0|$rowDatosIns['telcel']==NULL){
            echo '<label style="font-size: 9pt;">'.$rowDatosIns['telfijo'].'</label>';
        }else{
            echo '<label style="font-size: 9pt;">'.$rowDatosIns['telcel'].'</label>';
        }        
        echo '</td>';
 }
?>
